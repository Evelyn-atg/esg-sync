...
>
> ⚠️ **版本说明（2026-08-01）**：本文基于 repo 中 **2026-07-30 提交**的源码（`src/chandra_ocr_tester.py` / `numeric_extractor.py` / `utils.py`）。集群当前运行版本已改用 **LLM API**（非本地 Qwen-VL/7B），该新版代码**尚未提交到 repo**；待同步源码后本文 S3/S5/§6 将按新版更新。
